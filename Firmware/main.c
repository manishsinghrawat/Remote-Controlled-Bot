...
int dir;
   ...
   InitializeSystem();
	...
	ConvertADC();
	while ( BusyADC() )USBDeviceTasks();
if (ADRESL+256*ADRESH-dat<50 || ADRESL+256*ADRESH-dat>-50|| dat==-1)

	dat=ADRESL+256*ADRESH;
...
if(gpwm<dir && gpwm<30 && enb==1/* && ((grip-dat>30)||(grip-dat<-30))*/){
DigitalWrite(porta,2,dat<grip);
DigitalWrite(porta,3,dat>grip);
}
else{
...
gpwm++;
DigitalWrite(porta,4,down&&!DigitalRead(portb,5));
DigitalWrite(porta,5,up&&!DigitalRead(portb,2));
  ...
  //  }
    ...
    {   
        ...
        switch(ReceivedDataBuffer[0])
        {
			...
			case 0x82:
					//AnalogRead((int)ReceivedDataBuffer[0]);
			...
			case 0x83:
				grip=(int)ReceivedDataBuffer[1]*5;
				if(grip>190*5)
					grip=190*5;
				else if(grip<90*5)
					grip=90*5;
			...
			break;
			case 0x84:
				down=(char)ReceivedDataBuffer[1];
			break;
			case 0x87:
				up=(char)ReceivedDataBuffer[1];
			break;
			case 0x85:
				leftmotor=(int)ReceivedDataBuffer[1]-100;
			break;
			case 0x86:
				rightmotor=(int)ReceivedDataBuffer[1]-100;
			break;
			case 0x88:
				ToSendDataBuffer[0] =0x88;
        				ToSendDataBuffer[1] = DigitalRead(portb,0);
           ...
           break;
			case 0x89:
				ToSendDataBuffer[0] =0x89;
        				ToSendDataBuffer[1] = DigitalRead(portb,2);
			...
			case 0x90:
				ToSendDataBuffer[0] =0x90;
        				ToSendDataBuffer[1] = DigitalRead(portb,3);
                ...
                break;
			case 0x91:
					enb=(char)ReceivedDataBuffer[1];
						ToSendDataBuffer[0] =0x91;
        				ToSendDataBuffer[1] = enb;
